  ...
  return (
    <form className="max-w-md mx-auto my-4" onSubmit={onSubmit}>
      ...
      <div className="relative">
        ...
        />
        <button type="submit" className="absolute right-2.5 bottom-2.5 bg-gray-700 hover:bg-gray-800 text-white focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800 transition-colors duration-300 ease-in-out">Search</button>
      </div>
    </form>
  );
}
